...
//                     <h3 className="footer-title text-white">Discover SkillSwap</h3>
...
//                         <p className="link link-hover text-white">Blog</p>
//                     </div>
...
//                         <p className="link link-hover text-white">Careers</p>
//                         <p className="link link-hover text-white">Press</p>
//                     </div>
