        ...
        ${isActive ? "bg-gray-200 text-black" : "text-black"}`
          ...
          {!user && (
            <div className="flex gap-3">
              <Link to="/login"
                className="px-3 py-2 md:px-4 md:py-2 rounded-md bg-linear-to-r from-blue-500 to-purple-600 text-white font-semibold hover:scale-105 hover:shadow-md transition-all duration-300">
                Login
              </Link>
            </div>
          )}
